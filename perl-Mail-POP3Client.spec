...
cd %{_builddir}/Mail-POP3Client-2.19
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Mail-POP3Client-2.19/deblicense/
...
cp %{_builddir}/Mail-POP3Client-2.19/deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-Mail-POP3Client/1d2020afd1b3499b0c860c71903939a5c5731f0e
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/Mail/POP3Client.pm
