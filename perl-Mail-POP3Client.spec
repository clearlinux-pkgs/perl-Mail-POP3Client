...
Source0  : https://cpan.metacpan.org/authors/id/S/SD/SDOWD/Mail-POP3Client-2.20.tar.gz
...
%prep
%setup -q -n Mail-POP3Client-2.20
cd %{_builddir}
tar xf %{_sourcedir}/libmail-pop3client-perl_2.19-1.debian.tar.xz
cd %{_builddir}/Mail-POP3Client-2.20
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Mail-POP3Client-2.20/deblicense/
